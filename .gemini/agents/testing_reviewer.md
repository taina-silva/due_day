...
- **80% Coverage Standard:** Verify that every new or modified file achieves at least 80% code coverage. Exclude generated files (`.freezed.dart`, `.g.dart`), pure abstract contracts, or plain model files (without custom methods or custom serialization) from this expectation.
...
- [ ] Do all new or modified files meet the 80% coverage standard (excluding generated/abstract/method-less model files)?
